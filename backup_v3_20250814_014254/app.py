...
def create_app():
    ...
    # -------- CatÃ¡logo con filtros, orden y paginaciÃ³n
    @app.route("/")
    def index():
    ...
    # -------- Detalle: precio dinÃ¡mico, recomendaciones, reseÃ±as, wishlist toggle
    @app.route("/product/<int:pid>")
    def product_detail(pid: int):
        p = PokemonProducto.query.get_or_404(pid)

        # registrar vista si estÃ¡ logueado
...
def ensure_utf8(resp):
    # No toques JSON/estáticos; solo HTML sin charset explícito
